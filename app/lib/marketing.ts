...
export const META_DESC = PAYWALL_ENABLED
  ? "楽天で仕入れてeBayで売る！利益率が高い商品を自動でリストアップし、写真だけでほぼ自動のeBay出品まで。まずは30日無料でお試し（その後 月¥500〜）。"
  : "楽天で仕入れてeBayで売る！利益率が高い商品を自動でリストアップ。日本の商品を海外に輸出して副収入を得たい方向けのリサーチ＆出品ツール。";
...
export const PITCH_ONELINER = PAYWALL_ENABLED
  ? "楽天で仕入れてeBayで売る「利益が出やすい商品」をリサーチ＆ほぼ自動で出品できるツール（30日無料／月¥500〜）"
  : "楽天で仕入れてeBayで売る「利益が出やすい商品」を見つけるリサーチ＆出品ツール";
