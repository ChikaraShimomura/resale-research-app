...
export const WEIGHT_G = {
  トレカ: 250, // ★150→250(2026-07-20)：PSA鑑定スラブ+トップローダー/保護材込み(生カード前提の150は軽すぎ＝送料過小評価)
  トレカBOX: 800, // 未開封BOX(シュリンク付)＋緩衝材。パック単位はやや軽いが安全側に重め。
  コスメ: 350,
  ゲーム: 250,
  ゲーム機: 1500,
  フィギュア: 800,
  ...
  メガネ: 250,     // ブランドサングラス/眼鏡(ケース・箱込みで軽め・2026-07-09追加)。出品時に実重量で補正。
  筆記具: 150,     // 万年筆/ボールペン(箱込みで軽い・高単価・2026-07-09追加)。出品時に実重量で補正。
  カメラ: 1500,
