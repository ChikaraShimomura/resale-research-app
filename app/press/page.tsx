...
const SHORT_INTRO =
  "輸出ラボは、楽天で仕入れてeBayで売る「利益が出やすい商品」を見つけられるリサーチ＆出品支援ツールです。楽天の仕入れ値から、eBay手数料・国内送料・楽天ポイントまで引いた“手取りベースの想定利益率”を自動で表示。会員登録して使い、まずは30日無料でお試しできます（その後 月¥500〜）。（利益は想定・目安です）";

const LONG_INTRO = `「輸出ラボ」は、楽天で仕入れてeBayへ輸出・転売する副業のための、リサーチ＆出品支援ツールです。
...
会員登録して使えます。まずは30日無料でお試し（その後 月¥500〜）。
      ...
      <main className="max-w-2xl mx-auto px-4 py-5 space-y-3">
        ...
        <Card title="サービス概要">
          <ul className="space-y-1.5 text-[13px] text-gray-700 leading-relaxed">
            <li>・<b>一言</b>：楽天で仕入れてeBayで売る「利益が出やすい商品」を見つけるリサーチ＆出品支援ツール</li>
            <li>・<b>誰向け</b>：eBay輸出の初心者〜中級／楽天ポイントせどり層</li>
            <li>・<b>料金</b>：30日無料でお試し → その後 月¥500〜（要会員登録）</li>
