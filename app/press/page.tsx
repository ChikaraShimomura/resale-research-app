...
eBayで売れている型番を、日本の中古サイト（ハードオフ等）の現在価格と照合。eBay手数料（13.25%＋約47円）・国際送料・米国関税まで引いた“手取りベースの純利益率”を自動計算し、状態ランクつきで「いま仕入れて利益が出る中古」を一覧できます。毎日更新のランキングからも探せます。
      ...
      <main className="max-w-2xl mx-auto px-4 py-5 space-y-3">
        ...
        <Card title="特長">
          <ul className="space-y-1.5 text-[13px] text-gray-700 leading-relaxed">
            ...
            <li>・<b>毎日更新の利益ランキング</b>／儲かる中古の型番カタログ</li>
