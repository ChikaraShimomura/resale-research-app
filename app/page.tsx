...
export default function LandingPage() {
  return (
    <div className="min-h-dvh bg-[#F5F7FA]">
      ...
      {/* ヘッダー */}
      <header className="bg-gradient-to-r from-[#CC0033] to-[#E8003A] px-3 py-2.5 shadow-sm">
      ...
      {/* ヒーロー */}
      <div className="bg-gradient-to-br from-[#CC0033] via-[#D4003A] to-[#AA0028] text-white">
      ...
      <div className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-center gap-3">
            {[
              { step: "①", text: "楽天で仕入れ", sub: "ポイント最大20%還元", color: "bg-gradient-to-br from-[#CC0033] to-[#E8003A]" },
              { arrow: true },
      ...
      <section className="max-w-2xl mx-auto px-4 pb-8 text-center">
        <Link href="/search"
          className="inline-block bg-gradient-to-r from-[#CC0033] to-[#E8003A] hover:from-[#AA0028] hover:to-[#CC0033] text-white font-black px-8 py-3 text-sm transition-all shadow-md rounded-full">
          すべての利益商品を見る →
        </Link>
