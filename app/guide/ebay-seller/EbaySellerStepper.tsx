    ...
    <div className="space-y-3">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
        ...
        <ul className="space-y-2 text-[12px] text-gray-700 leading-relaxed">
          ...
          <li>
            🔴 <b>出品できる数が少ない・増やせない</b> → 新規は<b>出品上限（目安：月10品・合計500ドル）</b>があり、超えると止まります。これは正常で、<b>実績がつくと自動で増え</b>、マイeBayから引き上げ申請もできます（30日に1回）。
          </li>
          <li>
            🔴 <b>KYC完了メールが来たのに、まだ出品できない</b> → <b>eBay側の最終確認</b>のことがあります（PayoneerのKYCとは別物）。数時間〜数日待つか、eBayからの追加確認メールに対応してください。
          </li>
        </ul>
      </div>
