...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    Icon: PenLine,
    title: "eBayに出品する",
    desc: "商品カードの「eBay自動出品」を押すだけ。タイトル・価格・カテゴリは自動で入り、楽天の画像でそのまま出品できます。英語は不要です。",
    tips: ["写真は楽天の画像が自動で入ります（実物の写真は後から足せて、売れやすくなります）", "カテゴリが赤字で出たら、タイトルを具体的にして開き直すと通る", "価格・数量・送料サイズは出品後もアプリから編集できます"],
