...
const STEPS = [
  ...
  },
  {
    num: "03",
    title: "eBayに出品する",
    desc: "商品カードの「eBayで出品する」ボタンを押すと、タイトルが自動入力された出品ページが開きます。説明文・価格・送料を設定して出品完了です。",
  ...
  return (
    <div className="min-h-dvh bg-[#F5F5F5] pb-nav">
      ...
      <main className="max-w-2xl mx-auto px-3 py-4">
        ...
        {/* イントロ */}
        <div className="bg-gradient-to-r from-[#BF0000] to-[#E83820] rounded-lg p-4 mb-5 text-white">
          ...
          <div className="flex flex-col gap-2">
            {FAQS.map((faq, i) => (
              <div key={i} className="bg-white border border-gray-200 p-3">
                <p className="text-sm font-bold text-[#BF0000] mb-1">Q. {faq.q}</p>
