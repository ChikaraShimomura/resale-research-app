      ...
      <main className="max-w-2xl mx-auto px-4 py-5 space-y-3">
        ...
        <div className="bg-white rounded-2xl border border-[#A98B5C]/25 shadow-sm p-4">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            輸出ラボは<b>楽天市場</b>で日本の人気商品を仕入れ、eBayで海外に売ります。日本最大級の通販モールで、ふだん通り買えて<b>買うたびポイントが貯まる</b>のが強み。
          </p>
        </div>
        ...
        <Card icon={<Coins size={16} />} title="なぜ楽天で仕入れるの？">
          <p className="text-[13px] text-gray-600 leading-relaxed mb-2">
            ポイント還元のぶん<b>お得に仕入れられる</b>から。1万円の商品で2,000pt返れば、次の仕入れに使えて実質8,000円。<b>ポイントは利益とは別の“おまけ”</b>（利益計算には含めません）。
          </p>
          ...
          <p className="text-[11px] text-gray-400 mt-2">※ ポイントは1pt＝1円で次の仕入れにそのまま使えます。</p>
        </Card>

        {/* ポイント最大化 */}
        <Card icon={<Sparkles size={16} />} title="ポイントを最大化する3つのコツ">
          <ul className="space-y-2">
            <Tip><b>0と5のつく日</b>を狙う：エントリー＋楽天カード払いで<b>最大5倍</b>。</Tip>
            <Tip><b>楽天スーパーSALE / お買い物マラソン</b>：複数店舗で買うほど倍率UP。年数回<b>最大44倍</b>。</Tip>
            <Tip><b>SPU（スーパーポイントアッププログラム）</b>：対象サービスを使うほど毎回の倍率がベースから底上げ。</Tip>
          </ul>
          <div className="mt-3 flex items-start gap-2 bg-blue-50 border border-blue-100 rounded-xl px-3 py-2.5">
            ...
            <p className="text-[12px] text-blue-800 leading-relaxed">
              急がない仕入れは<b>還元率の高い日にまとめ買い</b>。同じ商品でも買う日でポイントが大きく変わります。
            </p>
          </div>
        </Card>
        ...
        <Card icon={<ShoppingBag size={16} />} title="仕入れの手順（3ステップ）">
          <ol className="space-y-3">
            {[
              ["輸出ラボで利益商品を見る", "利益・利益率・ポイントまで計算済みの商品を一覧で確認。"],
              ["楽天で買う（高還元日を狙う）", "商品カードの「楽天で仕入れる」から楽天へ。0と5のつく日やスーパーSALEならさらにお得。"],
              ["ポイントは次の仕入れへ", "貯まったポイントは1pt＝1円で次の仕入れに。回すほど実質コストが下がります。"],
            ].map(([t, d], i) => (
        ...
        <div className="flex items-start gap-2 bg-[#2D323B]/[0.05] border border-[#2D323B]/20 rounded-xl px-3 py-2.5">
          ...
          <p className="text-[12px] text-[#2D323B] leading-relaxed">
            <b>仕入れ前に確認：</b>モバイルバッテリー・香水・スプレー・電池内蔵品などは<b>国際郵便で送れない</b>ことが。「売れたのに送れない」を防ぐため<b>送れる商品か仕入れ前にチェック</b>。価格・在庫・ポイント倍率は変動します。
          </p>
        </div>
