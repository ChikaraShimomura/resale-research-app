...
const ebaySold = (c) =>
  c.ebaySoldUrl ||
  `https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent([c.brand, c.code].filter(Boolean).join(" ") || [c.brand, c.name].filter(Boolean).join(" "))}&LH_Sold=1&LH_Complete=1&_sop=13`;
