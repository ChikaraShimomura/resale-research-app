    ...
    try:
        msg = ai.messages.create(
            ...
            messages=[{"role": "user", "content": (
                f"{PERSONA}\n\n"
                "次のXの投稿への短いリプライ下書きを1つ作る。相手の投稿が主役、こちらは自然に反応して会話をつなぐ。\n"
                f"投稿:「{text[:280]}」\n\n"
                "【形】1〜2文・全角40〜60字目安。ただの相槌より“ひと言＋具体”で「おっ」と思わせる。改行は基本なし(長い時だけ1回)。\n"
                "【トーン】自然体の大人の口調。丁寧すぎず、でもギャル語・若者スラング・過度なタメ口はNG(「〜すぎw」「沼」「わかる〜」等は使わない)。落ち着いた親しみやすさ。\n"
                "【注目をひく】相手が『ちゃんと読んでくれてる』と感じる、その投稿ならではの具体に触れる。共感＋鋭い短い質問、または一歩踏み込んだ気づきをひと言。汎用コメント(『いいね！』等)は避ける(コピペ感＝逆効果)。\n"
                "【絶対NG】自分の宣伝・売り込み(URL・『うちのアプリ/ツール』・フォロー誘導)、上から目線・説教。\n"
                f"{HUMAN_EMOJI}\n"
                "※絵文字は0〜1個、締めに自然に置く程度。無理に付けない。\n"
                "【出力】本文のみ(前置き・カギ括弧・複数案は不要)。")}])
...
def main():
    ...
    lines = ["今すぐ反応したいXの投稿候補です。送信はあなたが行ってください（投稿後5〜15分が命）。",
             "相手の投稿を主役に・自己宣伝はしない。下書きは自然体で“ちゃんと読んでる”感のある短めのひと言＝テンポよく1日10〜15件どんどん。\n"]
